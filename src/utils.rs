...
impl <T> Matrix<T> {
    ...
    fn pos(&self, i: usize, j: usize) -> usize {
        debug_assert!(i < self.n_rows, "Out of matrix bounds: position ({}, {}), dimensions: {} * {}", i, j, self.n_rows, self.n_cols);
        debug_assert!(j < self.n_cols, "Out of matrix bounds: position ({}, {}), dimensions: {} * {}", i, j, self.n_rows, self.n_cols);
